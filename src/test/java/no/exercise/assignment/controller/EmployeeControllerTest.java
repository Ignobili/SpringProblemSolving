...
class EmployeeControllerTest {
    ...
    @Test
    void testRetrievingOfSingleEmployee() throws Exception {
    ...
    @Test
    void testRetrievingOfActiveEmployees() throws Exception {
    ...
    @Test
    void testRetrievingOfActiveEmployeesGroupedByDepartment() throws Exception {
